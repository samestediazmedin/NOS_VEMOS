...
- Reconocimiento de rostro por pixeles con embedding normalizado (centro de imagen + gradientes), util para validaciones MVP.
...
## Smoke de reconocimiento facial

Con servicios arriba y token por pasarela, ejecuta:

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-ia-face-recognition.ps1
```

Este smoke entrena un perfil y valida verificaciones con imagen similar y distinta.
